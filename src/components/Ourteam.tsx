                ...
                <div className="max-w-xs md:max-w-none mx-auto">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="inline-flex -mt-6 mb-5 items-center justify-center py-3 px-5 bg-white rounded-full">
                      ...
                      >
                        <img
                          src="https://shuffle.dev/saturn-assets/images/team/icon-facebook.svg"
                          alt=""
                        />
                      </a>
                      <a
                      ...
                      >
                        <img
                          src="https://shuffle.dev/saturn-assets/images/team/icon-linkedin.svg"
                          alt=""
                        />
                      </a>
                      <a
                      ...
                      >
                        <img
                          src="https://shuffle.dev/saturn-assets/images/team/icon-instagram.svg"
                          alt=""
                        />
                      </a>
                      <a
                      ...
                      >
                        <img
                          src="https://shuffle.dev/saturn-assets/images/team/icon-twitter.svg"
                          alt=""
                        />
                      </a>
                    </div>
              ...
              <div className="w-full px-4 mb-12">
                <div className="max-w-xs md:max-w-none mx-auto">
                  <div className="flex flex-col items-center">
                    <img
                      className="block h-48 w-48"
                      src="https://shuffle.dev/saturn-assets/images/team/circle-team-members1.png"
                      alt=""
                    />
                    <div className="inline-flex -mt-6 mb-5 items-center justify-center py-3 px-5 bg-white rounded-full">
                      <a
