...
const Navbar = () => {
  ...
  return (
    <>
    <nav className="bg-[#78ABA8] border-gray-200 sticky top-0 left-0 w-full z-50">
  <div className="max-w-screen-xl mb-4 flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <button
      ...
      type="button"
      className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm bg-[#78ABA8] text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400"
    ...
    <div className={`${isOpen ? 'block' : 'hidden'} w-full bg-[#78ABA8] md:block md:w-auto`} id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border bg-[#78ABA8] border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 ">
        <li>
        ...
        {isvalidadmin && (
          <li>
            <a href="/admin" className="block py-2 px-3 text-gray-900 bg-[#78ABA8] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Admin</a>
          </li>
        )}
        <li>
          <a href="/contact-us" className="block py-2 px-3 bg-[#78ABA8] text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact</a>
        </li>
        <li>
          {isSignedIn ? (
            ...
            <Link href="/sign-in" className="block py-2 px-3 bg-[#78ABA8] text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
              Sign In
            </Link>
          )}
        </li>
