        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap">
            {courseData.map((data, index) => (
              <a
                key={index}
                className="w-full text-gray-800 lg:w-1/3 p-4"
                href={data.link}
              >
                <div className="relative border border-gray-200 p-12 rounded-3xl h-full course-card">
                  <p className="text-xl tracking-tight font-semibold mb-4 course-title">
                    {data.coursename}
                  </p>
                  <p className="tracking-tight mb-12 course-description">
                    {data.description}
                  </p>
