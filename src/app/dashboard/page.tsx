        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-36">
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            <div className="text-center">
              <p className="text-xs font-semibold text-gray-900 tracking-wide uppercase mb-3  ">
                Organising Your Dashboard Please Wait...
              </p>
            </div>
          </div>
        </div>
      ...
      {IsUserFound ? (
        <section className="p-24 pb-28 bg-white overflow-hidden">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {coursedata?.user?.enrolledCourses[0].coursesdetails?.map(
              (data) => (
                <a
                  key={data.courseid}
        ...
        <div className="overflow-hidden mt-20 mb-36">
